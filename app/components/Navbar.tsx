      ...
      <header className="body-font bg-gray-950 shadow-md">
        <div className="mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
          ...
          <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            ...
            <Link href={"/hoodies"} className="mr-5 hover:text-gray-400 text-amber-50">Hoodies</Link>
            <Link href={"/mugs"} className="mr-5 hover:text-gray-400 text-amber-50">Mugs</Link>
            <Link href={"/stickers"} className="mr-5 hover:text-gray-400 text-amber-50">Stickers</Link>
          </nav>
